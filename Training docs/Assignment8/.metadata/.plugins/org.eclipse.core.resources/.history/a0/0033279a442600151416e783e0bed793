...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        ...
        <description>Email alert when the  Opportunity amount is greater then 5000.</description>
        <protected>false</protected>
        <recipients>
            <recipient>kalpesh.gandhi@eternussolutions.com</recipient>
            <type>user</type>
    ...
    <rules>
        ...
        <description>If Opportunity stage is in &apos;negotiation/review&apos; stage it sends an email to the opportunity owner indicating a big deal is being created.</description>
