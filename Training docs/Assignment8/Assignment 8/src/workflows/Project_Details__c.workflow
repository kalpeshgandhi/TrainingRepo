...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <description>Create a Calendar task for the Project whenever a new project is created and send Email Notification to Project Manager.</description>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
        <fullName>Email notification to Project Manager when End date is 5 Days Prior</fullName>
        <active>true</active>
        <criteriaItems>
            <field>Project_Details__c.End_Date__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <description>Email notification to remind the Project Manager about the end date of the project 5 days prior.</description>
    ...
    <rules>
        ...
        <active>true</active>
        <description>Sets the Project status as Closed if the End Date is today.</description>
