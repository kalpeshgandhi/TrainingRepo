...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        ...
        <description>This is a Field Update Task When the Current Employee Check box is False Then Record Type Is Non Technical.</description>
    ...
    <rules>
        <fullName>Email Notification To Project Manager When Record Is Deactivated%2E</fullName>
        <actions>
    ...
    <rules>
        ...
        <description>This is a Employee Record Which Selects the role for One To one relationship</description>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>Update Record Type to Non Technical If Current Employee is False%2E</fullName>
        <actions>
        ...
        <description>This is a Workflow to Update the Record type for the Employee is its Current Employee Check Box is False.</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
</Workflow>
